-- ============================================================================
-- TIDARO COMPREHENSIVE DATABASE SCHEMA (UUID Version)
-- Version: 1.1
-- Description: This script contains the complete, optimized, and merged
--              database schema for the Tidaro platform, using UUIDs for all
--              primary keys.
-- ============================================================================
...
CREATE TABLE ticketing.tickets (
    ...
    status_id UUID REFERENCES ticketing.statuses(id),
    priority_id UUID REFERENCES ticketing.priorities(id),
...
CREATE TABLE ticketing.comments (
    ...
    content TEXT NOT NULL,
    user_id UUID REFERENCES iam.profiles(user_id),
    ticket_id UUID REFERENCES ticketing.tickets(id) ON DELETE CASCADE,
    created_at TIMESTAMPTZ DEFAULT NOW(),
    updated_at TIMESTAMPTZ DEFAULT NOW()
);
