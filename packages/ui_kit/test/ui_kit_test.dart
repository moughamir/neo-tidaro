...
void main() {
  ...
  group('NeomorphicButton Tests', () {
    testWidgets('NeomorphicButton should render correctly', (WidgetTester tester) async {
    ...
    testWidgets('NeomorphicButton should change appearance when pressed', (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget(
        Center(
          child: NeomorphicButton(
            onPressed: () {},
      ...
      final BoxDecoration initialDecoration = initialContainer.decoration as BoxDecoration;
      ...
      final BoxDecoration pressedDecoration = pressedContainer.decoration as BoxDecoration;
      ...
      expect(pressedShadows[0].blurRadius, isNot(equals(initialShadows[0].blurRadius)));
    ...
    testWidgets('NeomorphicButton should respect custom properties', (WidgetTester tester) async {
  ...
  group('GlassyCard Tests', () {
    testWidgets('GlassyCard should render correctly', (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget(
        Center(
          child: GlassyCard(
            child: const Padding(
    ...
    testWidgets('GlassyCard should respect custom properties', (WidgetTester tester) async {
      ...
      expect(clipRRect.borderRadius, equals(BorderRadius.circular(customBorderRadius)));
    ...
    testWidgets('GlassyCard should handle child widgets properly', (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget(
        Center(
          child: GlassyCard(
            child: Column(
